...
export class ExpenseControllerService {
     ...
     */
    public addExpense(username: string, newExpenseDto: NewExpenseDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<MessageResponse>;
    public addExpense(username: string, newExpenseDto: NewExpenseDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<MessageResponse>>;
    public addExpense(username: string, newExpenseDto: NewExpenseDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<MessageResponse>>;
    public addExpense(username: string, newExpenseDto: NewExpenseDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (username === null || username === undefined) {
            throw new Error('Required parameter username was null or undefined when calling addExpense.');
        }
        if (newExpenseDto === null || newExpenseDto === undefined) {
            throw new Error('Required parameter newExpenseDto was null or undefined when calling addExpense.');
        }
